...
public:
    ListNode* mergeTwoLists(ListNode* l1, ListNode* l2) {
        ...
        while(l1 or l2) {
            if(l1 and l2 and l1->val<=l2->val) { ptr->next = l1; ptr = ptr->next; l1 = l1->next; }
            else if(l1 and l2) { ptr->next = l2; ptr = ptr->next; l2 = l2->next; }
            else if(l1) { ptr->next = l1; break; }
            else { ptr->next = l2; break; }
        }
        ptr = l->next;
        delete l;
        return ptr;
    ...
    ListNode* mergeTwoLists0(ListNode* l1, ListNode* l2) {
        ...
        while(l1 or l2) {
            if(l1 and l2) {
                if(l1->val<=l2->val) { c->next=l1; c=c->next; l1=l1->next; }
                else { c->next=l2; c=c->next; l2=l2->next; }
            }
            else if(l1) { c->next = l1; break; }
            else { c->next = l2; break; }
        }
        c = l->next;
        delete l;
        return c;
